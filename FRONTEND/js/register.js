...
const registerUser = async (obj) =>{
    ...
    await fetch("http://localhost:8000/register", {
        ...
        if(response.status){
            ...
            document.getElementById('activation_link').href = `http://127.0.0.1:5500/FRONTEND/html/user_activation.html?user_id:${response.userId}&activation_id:${response.activationLink}`
        }else{
